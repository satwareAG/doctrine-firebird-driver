...
/** @extends PlatformTestCase<Firebird3Platform> */
class Firebird3PlatformTest extends PlatformTestCase
{
...
';
    ...
    public function testGeneratesTypeDeclarationForIntegers(): void
    {
        ...
        self::assertSame('INTEGER GENERATED BY DEFAULT AS IDENTITY', $this->platform->getIntegerTypeDeclarationSQL(['autoincrement' => true]));
        self::assertSame('INTEGER GENERATED BY DEFAULT AS IDENTITY', $this->platform->getIntegerTypeDeclarationSQL(
    ...
    public function testAlterTableNotNULL(): void
    {
        ...
        // @phpstan-ignore-next-line (dead code after markTestSkipped — kept for historical reference)
...
,
    ...
    {
        return 'SELECT * FROM user OFFSET 2 ROWS FETCH NEXT 1 ROWS ONLY';
    }
}
