...
abstract class AbstractComparatorTestCase extends TestCase
{
    ...
    public function testCompareChangeColumnsMultipleNewColumnsRename(): void
    {
        ...
        $renamedColumns = RenameColumnTestHelper::getRenamedColumns($tableDiff);
    ...
    public function testDetectRenameColumnAmbiguous(): void
    {
        ...
        self::assertCount(0, RenameColumnTestHelper::getRenamedColumns($tableDiff));
    }
    ...
    {
        // jane: DBAL bug - detectRenamedIndexes() accesses $candidates[0] after
    ...
    public function testDiff(): void
    {
        ...
        self::assertEquals(['twitterId', 'displayName'], array_keys(RenameColumnTestHelper::getRenamedColumns($tableDiff)));
