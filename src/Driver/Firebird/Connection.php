...
final class Connection implements ServerInfoAwareConnection // @phpstan-ignore-line classImplements.deprecated
{
    ...
    public function lastInsertId($name = null): string|int|false
    {
        ...
        if ($name !== null && str_contains($name, '.')) {
            ...
            if ($genName !== null) {
                // Step 2: fbird_last_insert_id() with generator name — works on all Firebird versions.
                //         Returns the value generated by the most recent INSERT on this connection.
                try {
                    $lastVal = fbird_last_insert_id($this->connection, $genName);
                ...
                // Step 3: Fallback — read current generator value (increment by 0).
                try {
