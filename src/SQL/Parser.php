...
namespace Satag\DoctrineFirebirdDriver\SQL;

use Satag\DoctrineFirebirdDriver\SQL\Parser\Exception;
use Satag\DoctrineFirebirdDriver\SQL\Parser\Exception\RegularExpressionError;
 ...
 *
 * Copied from Doctrine\DBAL\SQL\Parser to avoid Symfony DebugClassLoader @internal deprecation notices triggered
 * by cross-vendor usage of the Visitor interface.
 *
...
final class Parser
{
    ...
    public function __construct(bool $mySQLStringEscaping)
    {
        ...
        $this->tokenPattern = '~\\G'
            ...
            . '|(?P<other>' . $sqlPattern . '|' . self::SPECIAL . ')'
            . '~s';
    }
