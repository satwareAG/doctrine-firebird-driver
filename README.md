...
- **php-firebird extension** v11.0+ (satwareAG fork with M3 opaque-object API, IBatch, Exception Mode, OO API, PHP 8.4/8.5 hardening)
...
- **PHP 8.2+** with `ext-firebird` (php-firebird v11.0+)
